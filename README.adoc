...
The main motivation of this approach is to help beginners to start with arquillian but keep in my that will you lose arquillian *platform modularity* so for example if one arquillian extension releases a new version you *cannot* benefit from it and will have to wait until next release of this project.  
